  ...
  return (
    <div className="frame-123">
      ...
      <Link href="/" className="flex items-center justify-center">
        {isActive('/') ? (
          <div className="nav-circle-active">
            <svg width="28" height="25" viewBox="0 0 38 34" fill="none">
        ...
        {isActive('/categories') ? (
          <div className="nav-circle-active">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
              <rect x="1.5" y="1.5" width="8" height="8" rx="2" stroke="#A369D0" strokeWidth="3"/>
              <rect x="14.5" y="1.5" width="8" height="8" rx="2" stroke="#A369D0" strokeWidth="3"/>
              <rect x="1.5" y="14.5" width="8" height="8" rx="2" stroke="#A369D0" strokeWidth="3"/>
              <rect x="14.5" y="14.5" width="8" height="8" rx="2" stroke="#A369D0" strokeWidth="3"/>
            </svg>
          </div>
        ) : (
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
            <rect x="1.5" y="1.5" width="8" height="8" rx="2" stroke="white" strokeWidth="3"/>
            <rect x="14.5" y="1.5" width="8" height="8" rx="2" stroke="white" strokeWidth="3"/>
            <rect x="1.5" y="14.5" width="8" height="8" rx="2" stroke="white" strokeWidth="3"/>
            <rect x="14.5" y="14.5" width="8" height="8" rx="2" stroke="white" strokeWidth="3"/>
          </svg>
        )}
      </Link>
