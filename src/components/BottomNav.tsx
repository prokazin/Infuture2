    ...
    <nav className="glass-nav fixed bottom-0 left-0 right-0 px-4 py-2 z-50">
      <div className="flex justify-around items-center max-w-md mx-auto">
        <Link href="/" className="flex flex-col items-center gap-0.5">
          <span className={`text-2xl ${isActive('/') ? 'text-primary' : 'text-gray-400'}`}>
            🏪
          </span>
        ...
        <Link href="/cart" className="flex flex-col items-center gap-0.5">
          <span className={`text-2xl ${isActive('/cart') ? 'text-primary' : 'text-gray-400'}`}>
            🛒
          </span>
        ...
        <Link href="/profile" className="flex flex-col items-center gap-0.5">
          <span className={`text-2xl ${isActive('/profile') ? 'text-primary' : 'text-gray-400'}`}>
            👤
          </span>
